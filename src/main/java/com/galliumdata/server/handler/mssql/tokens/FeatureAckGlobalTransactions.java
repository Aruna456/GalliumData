...
public class FeatureAckGlobalTransactions extends FeatureAck
{
    private byte isEnabled;
    
    public FeatureAckGlobalTransactions(final ConnectionState connectionState) {
    ...
    public int readFromBytes(final byte[] bytes, final int offset, final int numBytes) {
        ...
        if (length != 1) {
            throw new ServerException("db.mssql.protocol.InvalidLengthForLoginFeature", new Object[] { "GlobalTransactions", 1, length });
        }
