...
public class SSPIMessagePacket extends MSSQLPacket
{
    private byte[] data;
    
    public SSPIMessagePacket(final ConnectionState connectionState) {
    ...
    public String toString() {
        return "SSPI message: " + this.data.length + " bytes";
    }
    ...
    public boolean removeMember(final String key) {
        throw new ServerException("db.mssql.logic.CannotRemoveMember", new Object[] { key, "SSPI packet" });
    }
}
